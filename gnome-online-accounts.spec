...
Source0  : https://download.gnome.org/sources/gnome-online-accounts/3.32/gnome-online-accounts-3.32.0.tar.xz
...
%prep
%setup -q -n gnome-online-accounts-3.32.0
...
export LANG=C
export SOURCE_DATE_EPOCH=1557004567
export AR=gcc-ar
