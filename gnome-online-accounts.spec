...
Source0  : https://download.gnome.org/sources/gnome-online-accounts/3.52/gnome-online-accounts-3.52.1.tar.xz
...
%prep
%setup -q -n gnome-online-accounts-3.52.1
cd %{_builddir}/gnome-online-accounts-3.52.1
pushd ..
cp -a gnome-online-accounts-3.52.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1729530151
