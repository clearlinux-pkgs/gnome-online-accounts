...
Source0  : https://download.gnome.org/sources/gnome-online-accounts/3.38/gnome-online-accounts-3.38.0.tar.xz
...
%prep
%setup -q -n gnome-online-accounts-3.38.0
cd %{_builddir}/gnome-online-accounts-3.38.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1602269734
...
cp %{_builddir}/gnome-online-accounts-3.38.0/COPYING %{buildroot}/usr/share/package-licenses/gnome-online-accounts/21e40770dfa802576ee515345cef47ecedff6524
%make_install
