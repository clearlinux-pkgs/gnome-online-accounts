...
Source0  : https://download.gnome.org/sources/gnome-online-accounts/3.30/gnome-online-accounts-3.30.0.tar.xz
...
Requires: gnome-online-accounts-license
...
%prep
%setup -q -n gnome-online-accounts-3.30.0
...
export LANG=C
export SOURCE_DATE_EPOCH=1535838670
...
export SOURCE_DATE_EPOCH=1535838670
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/doc/gnome-online-accounts
cp COPYING %{buildroot}/usr/share/doc/gnome-online-accounts/COPYING
%make_install
...
%files license
%defattr(-,root,root,-)
/usr/share/doc/gnome-online-accounts/COPYING
