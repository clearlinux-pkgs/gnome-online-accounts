...
Source0  : https://download.gnome.org/sources/gnome-online-accounts/3.40/gnome-online-accounts-3.40.1.tar.xz
...
%prep
%setup -q -n gnome-online-accounts-3.40.1
cd %{_builddir}/gnome-online-accounts-3.40.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1634592755
...
cp %{_builddir}/gnome-online-accounts-3.40.1/COPYING %{buildroot}/usr/share/package-licenses/gnome-online-accounts/21e40770dfa802576ee515345cef47ecedff6524
%make_install
